...
function PrintableForm({record}) {
  ...
  return <div className="print-document"><article className="a4-form">
    ...
    <div className="a4-lines">
      ...
      <div className="a4-line">๑๑. พฤติกรรมเสี่ยง <Check active={r.riskBehaviors?.includes('สารเสพติด')}/> พฤติกรรมการใช้สารเสพติด คือ <Fill width="74mm">{riskDetailFor('สารเสพติด')}</Fill></div>
      <div className="a4-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<Check active={r.riskBehaviors?.includes('ทางเพศ')}/> พฤติกรรมทางเพศ คือ <Fill width="88mm">{riskDetailFor('ทางเพศ')}</Fill></div>
      <div className="a4-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<Check active={r.riskBehaviors?.includes('ความรุนแรง')}/> พฤติกรรมการใช้ความรุนแรง คือ <Fill width="72mm">{riskDetailFor('ความรุนแรง')}</Fill></div>
